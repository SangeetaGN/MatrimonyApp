...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val uid = applicationContext.getSharedPreferences("matrimony", Context.MODE_PRIVATE)
...
//                        infoLayout.visibility = View.GONE
                ...
                if (it != null && !it.photoUrl.isBlank() || it.photoUrl.length > 5) {
                    if (it.isSuspended) {
        ...
        when (item.itemId) {
            ...
            R.id.option_signout -> {
                ...
                val sharedPreferences =
                    applicationContext.getSharedPreferences("matrimony", Context.MODE_PRIVATE)
