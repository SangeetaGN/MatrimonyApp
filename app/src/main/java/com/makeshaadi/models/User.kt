...
@Parcelize
data class User(
    val email: String? = "gsana12345@gmail.com",      //done //Must be first
    var uid: String? = "123",      //done
    var displayName: String = "Sangeeta", //done
    var age: Int? = 25,          //done
    var photoUrl: String = "",      //done
    var idProofUrl: String = "",        //done
    var phoneNumber: Number = 8296703212,        //done
    var gender: Gender = Gender.Female, //done
    var createdFor: String = "",     //done
    var createdAt: Long = System.currentTimeMillis(),
    var lastSignInAt: Long = System.currentTimeMillis(),
    var address: String = "Bangalore",       //done
